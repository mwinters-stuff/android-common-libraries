 ...
 */
public class ServerManagedPolicy implements com.android.vending.licensing.Policy {

    private static final String TAG = "ServerManagedPolicy";
    private static final String PREFS_FILE = "ServerManagedPolicy";
    ...
    private com.android.vending.licensing.PreferenceObfuscator mPreferences;

    /**
     * @param context The context for the current application
     * @param obfuscator An obfuscator to be used with preferences.
     */
    public ServerManagedPolicy(Context context, com.android.vending.licensing.Obfuscator obfuscator) {
        // Import old values
        SharedPreferences sp = context.getSharedPreferences(PREFS_FILE, Context.MODE_PRIVATE);
        mPreferences = new com.android.vending.licensing.PreferenceObfuscator(sp, obfuscator);
