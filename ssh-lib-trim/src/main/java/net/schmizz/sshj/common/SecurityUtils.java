...
public class SecurityUtils {
   ...
   // private static final Logger LOG = LoggerFactory.getLogger(SecurityUtils.class);
    ...
    public static final String BOUNCY_CASTLE = "SC";
            ...
            if (securityProvider == null && (registerBouncyCastle == null || registerBouncyCastle))
                ...
                try {
                    ...
                    if (registerBouncyCastle == null)
                        Log.i("tag","BouncyCastle not registered, using the default JCE provider");
                    else {
                        Log.e("ssh","Failed to register BouncyCastle as the defaut JCE provider");
