...
import nz.org.winters.android.common.appbilling.Security.VerifiedPurchase;
  ...
  class CheckBillingSupported extends BillingRequest
  {
    ...
    protected long run() throws RemoteException
    {
      ...
      if(response != null)
      {
        ...
        billingSupported = (responseCode == ResponseCode.RESULT_OK.ordinal());
      }
...
//      Toast.makeText(this, "BS.handlecommand " + action, Toast.LENGTH_LONG).show();
  ...
  private void purchaseStateChanged(int startId, String signedData, String signature)
  {
    ...
    if (purchases == null)
    {
//      Toast.makeText(this, "BS.purchaseStateChanged purchases null", Toast.LENGTH_LONG).show();
      return;
    }
