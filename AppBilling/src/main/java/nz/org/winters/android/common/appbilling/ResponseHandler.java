...
import nz.org.winters.android.common.appbilling.BillingService.RequestPurchase;
import nz.org.winters.android.common.appbilling.BillingService.RestoreTransactions;
import nz.org.winters.android.common.appbilling.Consts.PurchaseState;
import nz.org.winters.android.common.appbilling.Consts.ResponseCode;
...
//              if(productId.equalsIgnoreCase(StaticInfo.inAppPurchaseProduct(context)))
//              {
//                DatabaseHelper.setIsInAppPaidVersion(context, purchaseState == PurchaseState.PURCHASED);
//              }

              if(sPurchaseObserver != null)
              {
                int quantity = sPurchaseObserver.postBackgroundPurchaseStateChange(
