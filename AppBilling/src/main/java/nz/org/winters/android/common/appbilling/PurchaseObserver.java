...
public abstract class PurchaseObserver {
    ...
    /**
     * do database updates in the background thread.
     * @param purchaseState the purchase state of the item
     * @param itemId a string identifying the item
     * @param quantity the quantity of items in this purchase
     * @return the total number of that item owned.
     */
    public abstract int postBackgroundPurchaseStateChange(PurchaseState purchaseState, String itemId,
